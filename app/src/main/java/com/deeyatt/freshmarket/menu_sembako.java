...
public class menu_sembako extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_sembako); // layout menu_buah.xml
        ...
        btnBack.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(menu_sembako.this, homepage.class);
