...
public class menu_buah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_buah); // layout menu_buah.xml
        ...
        btnBack.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(menu_buah.this, homepage.class);
