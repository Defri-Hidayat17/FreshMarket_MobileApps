...
public class menu_daging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_daging); // layout menu_buah.xml
        ...
        btnBack.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(menu_daging.this, homepage.class);
